...
const config: runtime.GetPrismaClientConfig = {
  generator: {
    ...
    output: {
      value:
        '/home/adil/Документы/works/Grammar-Hero/apps/server/prisma/generated',
      fromEnvVar: null,
    },
    config: {
      moduleFormat: 'esm',
    ...
    previewFeatures: [],
    sourceFilePath:
      '/home/adil/Документы/works/Grammar-Hero/apps/server/prisma/schema/schema.prisma',
    isCustomOutput: true,
  },
  relativePath: '../schema',
  ...
  inlineSchemaHash:
    '5960d1e2db60ee2dd204f937741594985cd7a65c6bada456ce8a933b8e28b45c',
  copyEngine: true,
  runtimeDataModel: {
    models: {},
    enums: {},
